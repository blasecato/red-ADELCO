        ...
        return(
            <div className="users">
                ...
                <div className="users--title">
                    <h1 className="users--title--cron">Tipo de Linea Productiva</h1>
                </div>
                <div className="users__content-cards">
                    <Card
                        className="users__content-cards--card"
                        hoverable
                        cover={<Link to="/registrarline"><img alt="example" src={usernew} /></Link>}
                    >
                        <Meta title="Cafe" description="Cadena productiva de cafe" />
                        <Link className="btn" to="/registrarline" type="primary" shape="circle">
                            IR
                        </Link>
                    </Card>
                    <Card
                        className="users__content-cards--card"
                        hoverable
                        cover={<Link to="/registrarline"><img alt="example" src={queryuser} /></Link>}
                    >
                    ...
                    <Card
                        className="users__content-cards--card"
                        hoverable
                        cover={<Link to="/registrarline"><img alt="example" src={updateuser} /></Link>}
                    >
                    ...
                    <Card
                        className="users__content-cards--card"
                        hoverable
                        cover={<Link to="/registrarline"><img alt="example" src={deleteuser} /></Link>}
                    >
